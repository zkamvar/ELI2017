...
\begin{itemize}
  ...
  \item \textbf{24 months:} Course completed (\textbf{I, L, M}), materials freely available in the public domain, manuscripts submitted as preprints to the Open Science Framework and to both \textit{Molecular Ecology} and \textit{Plant Health Instructor} (\textbf{K, N})
\end{itemize}

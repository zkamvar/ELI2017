...
% Sydney's first impression:
% My first impression is that you need to add information that introduces who
% you are and what work you have done previously, which all lead up to your
% current research/career goals.
...
% Sydney:
% I encourage you to mention early on that this kind of teaching training is
% something that will help you in both getting your job and also serve as
% something that you can take with you to your faculty position and teach there
% as well.
...
\begin{itemize}
  ...
  \item \textbf{Inexperienced In:} coalescent analysis, Bayesian statistics, phylogeographic analysis % SYD: add population genomics here?
\end{itemize}
...
\begin{figure}[!htbp]
  ...
  \caption{Project Timeline with milestones labeled as red diamonds}
  \label{fig:timeline}
\end{figure}
...
\begin{itemize}
  \item \textbf{6 months:} Genomes sequenced (\textbf{E, F}), workshops on teaching and molecular evolution attended, outline for each week of course created, preregistration of research uploaded to the Open Science Framework
  \item \textbf{12 months:} Genomes assembled (\textbf{G}), population genetic analysis performed (\textbf{H}), lesson plans for each week of the course completed (\textbf{A}), special topics course registered, course website created, presentation at UNL Plant Pathology Seminar held.
  \item \textbf{18 months:} Presentation at APS National Meeting on research, course for graduate students underway
  \item \textbf{24 months:} Course completed (\textbf{B, C}), materials freely available in the public domain, manuscripts submitted as preprints to the Open Science Framework (\url{https://osf.io/preprints/}) and to both \textit{Molecular Ecology} and \textit{Plant Health Instructor} (\textbf{D, I}).
\end{itemize}
